...
const TourDetail = () => {
  ...
  const relatedTours = [
    {
      title:
        "Tour Cano 3 Đảo Phú Quốc Trong Ngày: Cano Hòn Mây Rút - Hòn Móng Tay - Gầm Ghì",
      duration: "1 ngày",
    ...
    {
      title:
        "Tour Phú Quốc 3N2Đ: Grand World - Thị Trấn Hoàng Hôn - Cáp Treo Hòn Thơm",
      duration: "3 ngày",
  ...
  const relatedTours2 = [
    {
      title:
        "Tour Phú Quốc 3N2Đ: HCM - Grand World - Cáp Cầu - Làng Nghề San Hô",
      duration: "3 ngày",
    ...
    {
      title:
        "Tour Phú Quốc 3N4Đ: HCM - Hà Nội - Sapa - Lào Cai - Ninh Bình - Hạ Long",
      duration: "7 ngày",
          ...
          <div className="content-left">
            ...
            <div className="card">
              ...
              <ul className="experience-list">
                <li>
                  - Thưởng thức hải sản tươi ngon, đặc sản nổi tiếng của đảo
                  ngọc
                </li>
                <li>
                  - Phiêu lưu tại VinWonders và Safari: thỏa thích giải trí và
                  đồng vui hoàng gia
                </li>
                <li>
                  - Tham quan cánh đồng bao trọn khu Hòn Thơm và khám phá vẻ đẹp
                  tại Aquatopia
                </li>
                <li>
                  - Check-in Sunset Town: ngắm hoàng hôn tuyệt đẹp và chiêm
                  ngưỡng cầu Hôn bắc ngang
                </li>
                <li>
                  - Khám phá Grand World: thành phố không ngủ với giải Venice
                  bao gồm phố Tàu, và chùa Tịnh Hòa Việt Nam
                </li>
              </ul>
            </div>
              ...
              <div className="program-list">
                <div className="program-item">
                  ...
                  <div className="program-content">
                    ...
                    <div className="program-description">
                      HCM - Phú Quốc - Grand World (Ăn Trưa)
                    </div>
                  </div>
                </div>
                ...
                <div className="program-item">
                  ...
                  <div className="program-content">
                    ...
                    <div className="program-description">
                      Hòn Thơm/Cano 4 Đảo - Sunset Town (Ăn Sáng, Trưa, Tối)
                    </div>
                  </div>
                </div>
                ...
                <div className="program-item">
                  ...
                  <div className="program-content">
                    ...
                    <div className="program-description">
                      Mua Sắm - Chợ Tây Phú Quốc (Ăn Sáng, Trưa)
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div key={index} className="tour-card">
                ...
                <div className="tour-content">
                  ...
                  <div className="tour-features">
                    • Hòn Gầm Ghì • Hòn Mây Rút • Quay Phim
                  </div>
            ...
            {relatedTours2.map((tour, index) => (
              <div key={index} className="tour-card">
                ...
                <div className="tour-content">
                  ...
                  <h3 className="tour-card-title">{tour.title}</h3>
                  <div className="tour-features">
                    • Grand World • Aquatopia • Sunset Town
                  </div>
                  <div className="tour-price">{tour.price}</div>
                </div>
              </div>
